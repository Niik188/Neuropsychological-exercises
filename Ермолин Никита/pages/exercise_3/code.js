...
rotate_button.addEventListener('click', (e)=>{
    ...
    rotate_back_button.addEventListener('click',()=>{
        ...
        if(cube1_rotate[0] == -90&&cube1_rotate[1] == 90&&cube1_rotate[2] == 90){
            score+=1
        }
        if(cube2_rotate[0] == -90&&cube2_rotate[1] == 0&&cube2_rotate[2] == 0){
            score+=1
        }
        if(cube3_rotate[0] == -90&&cube3_rotate[1] == 270&&cube3_rotate[2] == -90){
            score+=1
        }
        if(cube4_rotate[0] == -90&&cube4_rotate[1] == 90&&cube4_rotate[2] == 90){
            score+=1
        }
        if(cube5_rotate[0] == -90&&cube5_rotate[1] == 90&&cube5_rotate[2] == 90){
            score+=1
        }
        if(cube6_rotate[0] == -90&&cube6_rotate[1] == 180&&cube6_rotate[2] == 180){
            score+=1
        }
        localStorage.setItem('score', parseInt(localStorage.getItem("score"))+score);
        if (score >= 6) {
            localStorage.setItem('exercise3', 1); 
        }else if (score < 6) {
            localStorage.setItem('exercise3', 2); 
        }
